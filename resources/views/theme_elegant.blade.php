...
<html>
  <head>
    ...
    <link href="webarch/css/themes/webarch.elegant.css" rel="stylesheet" type="text/css" />
      ...
      <div class="page-content">
        ...
        <div class="content">
          ...
          <div class="page-title"> <i class="icon-custom-left"></i>
            <h3>Theme - <span class="semi-bold">Elegant</span></h3>
          </div>
          <div class="row">
            <div class="col-md-7">
            ...
            <div class="col-md-5">
              <div class="grid simple">
                ...
                <div class="grid-body no-border">
                  ...
                  <code>
           			webarch/css/themes/webarch.elegant.css
           		</code>
                  <br>
                  <br>
