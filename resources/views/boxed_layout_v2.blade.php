    ...
    <div class="header navbar navbar-inverse ">
      ...
      <div class="navbar-inner">
        <div class="header-seperation">
          ...
          <!-- BEGIN LOGO -->
          <a href="/"><img src="assets/img/logo/currenttech_logo.svg" class="logo" alt="" data-src="assets/img/logo/currenttech_logo.svg" data-src-retina="assets/img/logo2x.png" width="106" height="21" /></a>
          <!-- END LOGO -->
          <ul class="nav pull-right notifcation-center">
            ...
            <li class="dropdown" id="header_inbox_bar">
              <a href="/email" class="dropdown-toggle">
                <div class="iconset top-messages"></div> <span class="badge" id="msgs-badge">2</span> </a>
            </li>
        ...
        <div class="header-quick-nav">
          ...
          <div class="pull-left">
            <ul class="nav quick-section">
              <li class="quicklinks">
                <a href="#" class="" onclick="$('body').condensMenu();">
            ...
            <ul class="nav quick-section ">
              <li class="quicklinks">
                ...
                <ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
                  <li><a href="/user-profile"> My Account</a>
                  </li>
                  <li><a href="/calender">My Calendar</a>
                  </li>
        ...
        <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
          ...
          <ul>
            ...
            <li class="open active">
              <a href="javascript:;"> <i class="material-icons">airplay</i> <span class="title">Layouts</span> <span class=" open  arrow"></span> </a>
              <ul class="sub-menu">
