      ...
      <div class="page-content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li class="active"> <a href="/group_list">Group list </a> </li>
                        </ul>
                      </div>
                      <div class="col-sm-3">
        ...
        <div class="content">
          <ul class="breadcrumb">
            ...
            <li><a href="#" class="active">Horizontal Menu</a> </li>
          </ul>
          <div class="page-title"> <i class="icon-custom-left"></i>
            <h3>Horizontal - <span class="semi-bold">Menu</span></h3>
          </div>
          <div class="row">
            <div class="col-md-7">
            ...
            <div class="col-md-5">
              <div class="grid simple">
                ...
                <div class="grid-body no-border">
                  <p>Simply copy the top horizontal tags from the HTML you will find it in the div tag with the class
                  </p>
                  <code>
           			.bar
           		</code>
                  <br>
                  <br> Also do not forget to add the class
                  <br>
                  <code>horizontal-menu</code> to your
                  <br>body tag
                  <br>
                  <br>
                  <p>For those who want to get there less or SCSS update simply import the file horizontal_menu.less / horizontal_menu.scss from the modules folder
                </div>
              </div>
            </div>
          </div>
